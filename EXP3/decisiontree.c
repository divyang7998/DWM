...
//Average and Gain of Temp
	...
	if(gainTemp>gainWindy){
		...
		if(gainHumidity>gainOutlook && gainHumidity>gainTemp && gainHumidity>gainWindy)
			maxGain=gainHumidity;
		else if(gainOutlook>gainHumidity && gainOutlook>gainTemp && gainOutlook>gainWindy)
			maxGain=gainOutlook;
		else if(gainTemp>gainHumidity && gainTemp>gainOutlook && gainTemp>gainWindy)
			maxGain=gainTemp;
		else
			maxGain=gainWindy;
